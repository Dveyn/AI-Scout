...
Скрипт сам: venv, зависимости, Chromium, Office UI, `scout/.env` с паролем, PM2 (Scout + планировщик + Office).

**Автодеплой:** push в `main` → GitHub Actions. См. [docs/CICD.md](docs/CICD.md).
...
| Файл | Содержание |
|------|------------|
| [docs/CICD.md](docs/CICD.md) | **CI/CD** — GitHub Actions, автодеплой, автономность |
...
| [office/QUICKSTART.md](office/QUICKSTART.md) | CEO задачи → Cursor |
